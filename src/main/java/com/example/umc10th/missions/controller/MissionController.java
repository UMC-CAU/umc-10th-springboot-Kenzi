...
public class MissionController {
    ...
    public ApiResponse<List<MissionResDTO.GetMissionDoingResponse>> getMissionDoing(@RequestBody MissionReqDTO.GetMissionListRequest missionReqDTO) {
        List<MissionResDTO.GetMissionDoingResponse> missions = missionService.getMissionDoing(missionReqDTO.address() ,missionReqDTO.userId());
    ...
    public ApiResponse<List<MissionResDTO.GetMissionDoneResponse>> getMissionDone(@RequestBody MissionReqDTO.GetMissionListRequest missionReqDTO) {
        List<MissionResDTO.GetMissionDoneResponse> missions = missionService.getMissionDone(missionReqDTO.userId(),missionReqDTO.address());
