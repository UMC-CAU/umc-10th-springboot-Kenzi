...
-- ------------------------------------------------------------
CREATE TABLE `user` (
umc                        `id`           BIGINT       NOT NULL AUTO_INCREMENT COMMENT 'AUTO_INCREMENT',
...
CREATE TABLE `store` (
                         ...
                         `ceo_id`          BIGINT       NOT NULL COMMENT '가게 사장 아이디',
                         `food_id`         BIGINT       NOT NULL,
